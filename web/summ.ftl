    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-8 order-md-1">
                <h4 class="mb-3">${summPizza}</h4>
                <form method="post" class="needs-validation">

                    <div class="row">
                        <div class="col-md-12 mb-6">
                            <#assign total = 0>
                            <textarea name="ingredients" style="display:none"><#list summIngredient as p>${p}, </#list></textarea>
                            <#list summIngredient as p>${p}
                            <#list ingredients as x>
                            <#if x.name?contains("${p}")>
                            ...
                            <br>
                            <h4 class="mb-3">TOTAL PRICE: $${total * 1.5}</h4>
                              <input type="hidden" value="${total}" name="price">
                            <input type="hidden" value="${summPizza}" name="pizza">
                            </div>
                        </div>
                    <hr class="mb-4">
                    <button class="btn btn-primary btn-lg btn-block" type="submit">ORDER PIZZA</button>
                    </form>
                </div>
            </div>
